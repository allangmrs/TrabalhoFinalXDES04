export const COUNTRIES = [
  ...
  "Quênia","Quirguistão",
  "Reino Unido","República Centro-Africana","República Democrática do Congo","República Dominicana","República Tcheca","Romênia","Ruanda","Rússia",
  "Saint Kitts e Nevis","Samoa","San Marino","Santa Lúcia","São Tomé e Príncipe","São Vicente e Granadinas","Senegal","Serra Leoa","Sérvia","Seychelles","Singapura","Síria","Somália","Sri Lanka","Sudão","Sudão do Sul","Suécia","Suíça","Suriname",
...
export const BOOK_CATEGORIES = [
  "Literatura Brasileira","Literatura Estrangeira","Romance","Ficção Científica","Fantasia","Terror","Suspense","Aventura","Biografia","História","Filosofia","Sociologia","Psicologia","Educação","Administração","Economia","Direito","Informática","Engenharia","Matemática","Física","Química","Biologia","Medicina","Autoajuda","Religião","Infantil","Juvenil","HQs e Mangás","Outros",
];